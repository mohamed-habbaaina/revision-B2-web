...
function limitContent(array) {
    ...
    for (const article of array) {
        ...
        htmlContent += `<h2>Title: ${article.title}</h2>`;
        ...
        console.log(`Content: ${resumContent}`)
        console.log(`Created date: ${formattedCreatedAt}`)
        console.log(`Updated date: ${formattedUpdatedAt}`);
    }
